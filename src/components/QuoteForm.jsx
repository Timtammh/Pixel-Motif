...
const inputClasses =
  'w-full rounded-lg border border-line bg-white px-4 py-3 text-sm text-ink placeholder:text-ink-soft/60 outline-none transition-colors focus:border-accent focus:ring-2 focus:ring-accent/20'
...
export default function QuoteForm() {
  ...
  if (submitted) {
    return (
      <div className="rounded-2xl border border-line bg-white p-8 text-center sm:p-10" role="status">
        <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-accent-light text-accent-dark">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            <path d="M20 6 9 17l-5-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
        <h3 className="mt-5 font-display text-xl font-medium text-ink">Thanks — request received.</h3>
  ...
  return (
    ...
    >
      <h3 id="quote-form-heading" className="font-display text-xl font-medium text-ink">
      ...
      <div className="mt-7 grid gap-5">
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <div>
            <label htmlFor="business" className="mb-1.5 block text-xs font-medium text-ink">
              Business name
            </label>
      ...
      <button
        type="submit"
        className="mt-7 inline-flex w-full items-center justify-center rounded-full bg-ink px-7 py-3.5 text-sm font-medium text-paper transition-colors hover:bg-accent-dark sm:w-auto"
      >
        Send Quote Request
      </button>
    </form>
